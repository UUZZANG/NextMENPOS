				...
				builder: (context, provider, child) {
					...
					return ListView.builder(
						...
						itemBuilder: (context, index) {
							...
							return  InkWell(
								onTap: (){									
									_showdialog(context, "${noticeList[index].title}","${noticeList[index].content}");
								},
								child: ListTile(
									title:  Card(child: Text("${noticeList[index].title}"
												...
												children: [
													...
													Row(children: [
																	SizedBox(														
																		height:70,
																		width: 400,
																		child: Center( child:Text( "${noticeList[index].content}"																						
																						, overflow: TextOverflow.ellipsis)),
																	)]
													),
													Row(	
