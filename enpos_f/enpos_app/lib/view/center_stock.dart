...
class _CenterStorckViewState extends State<CenterStorckView> {
	...
	//임시로 2개 보이기
	List<TextEditingController> _qtyController = [TextEditingController(text:"1"),TextEditingController(text:"1")];	


	var huCodes = ["88999000R","88999000V"];
	var items = [{
		'addqty':'1',
		'companyId':'conpany222','huNo':'88999000V',},{
		'addqty':'1',
		'companyId':'conpany11',
						...
						itemBuilder: (context, index) {							
							return  ListTile(
										shape: RoundedRectangleBorder(
												...
												side: BorderSide(color: const Color.fromARGB(255, 158, 158, 158))), 
															...
															OutlinedButton( 
																onPressed: () {
																	if (items[index]['addqty'] == "1") {
																		...
																		items[index]['addqty'] = (int.parse(items[index]['addqty']!) - 1).toString() ;
				...
				floatingActionButton :  ElevatedButton(
						onPressed: () {
							_qrBarCodeScannerDialogPlugin.getScannedQrBarCode(
								...
								onCode: (code) {
									setState(() {									
										items.add({'huNo':code!,'addqty':'0', 'companyId':'conpany11',});										
